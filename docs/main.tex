...
\lstinputlisting[language=Java]{listings/MainClass.java}
\subsection*{Histogram.java}
\lstinputlisting[language=Java]{listings/Histogram.java}
\subsection*{ThreshApply.java}
\lstinputlisting[language=Java]{listings/ThreshApply.java}
\subsection*{ImageInputFormat.java}
\lstinputlisting[language=Java]{listings/ImageInputFormat.java}
\subsection*{ImageRecordReader.java}
\lstinputlisting[language=Java]{listings/ImageRecordReader.java}
\subsection*{LongArrayWritable.java}
\lstinputlisting[language=Java]{listings/LongArrayWritable.java}
\subsection*{Image.java}
\lstinputlisting[language=Java]{listings/Image.java}
